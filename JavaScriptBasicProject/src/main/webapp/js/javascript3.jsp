     ...
     <div class="row">
       <table class="table">
         <tr>
           ...
           <td colspan="2"><h3>[만개특가] 전통 수타방식 사누끼우동 면10인분+가쓰오 소스10개</h3><sub style="color:gray">따뜻하고 얼큰한 맛이 일품!</sub></td>
         </tr>
         <tr>
           <td colspan="2">
         ...
         <tr>
           <td colspan="2">
            <span style="color:green">첫구매할인가&nbsp;&nbsp;10,165원</span>
           </td>
         </tr>
         <tr>
           <td colspan="2">
         ...
         <tr>
           <td width=30%>
            <span value="10700" id="price">10,700</span>
           </td>
           <td width=40%>
