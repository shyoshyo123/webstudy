...
<%
    ...
    addr1=addr1.trim();
    //서울특별시 서초구 강남대로 615 1F 지번 서울시 서초구 잠원동 12-21 1F
  ...
  <div class="row">
   ...
   <div class="col-sm-5">
     <div id="map" style="width:100%;height:350px;"></div>
		...
		<script>
		var mapContainer = document.getElementById('ce8b10d84ca7d1760b64895b836edea3'), // 지도를 표시할 div 
		    mapOption = {
