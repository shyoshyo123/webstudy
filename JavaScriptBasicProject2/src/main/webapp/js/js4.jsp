...
window.onload=function(){
	...
	document.querySelector('#list').innerHTML=html;// 객체모델 => 태그를 선택해서 가지고 온다 : 이벤트처리 , 데이터 첨부가 가능 
	// 자바 => 데이터를 가지고 온다 (JSON) ==> 자바스크립트 자체에서 처리 
	// JSP가 변경하지 않는다 => 같은 화면에서 처리 => web2.0 (AJAX) 
}
